            ...
            <div class="card-body">
                <form @submit.prevent="guardar">
                    ...
                    <div class="d-grid col-6 mx-auto mb-3">
                        <button class="btn btn-success"><i class="fa-solid fa-floppy-disk"></i> Retirar</button>
                    </div>
                </form>
            </div>
        </div>
...
export default {
    data() {
        return {
            valor: '',
            url: 'http://localhost/cuentabancaria/public/api/clientes/retirar',
            cargando: false,
        };
    },
    ...
    methods: {
        async guardar() {
            if (!this.valor || this.valor <= 0) {
                ...
                enviarSolicitud('POST', parametros, this.url, 'Proceso realizado!!')
            }
        },
    }
};
